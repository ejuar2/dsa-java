...
public class GraphTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(graph.getIncomingEdges(2));
        ...
        HashSet<Integer> edges2 = new HashSet<>();
        edges2.add(2);
        edges2.add(0);
        edges2.add(1);

        HashSet<HashSet<Integer>> edgeSet = new HashSet<>();
        edgeSet.add(edges);

        if (!edgeSet.contains(edges2))
            edgeSet.add(edges2);

        System.out.println(edgeSet.size());

        if (edges.equals(edges2)) System.out.println("TRUUUUU");
